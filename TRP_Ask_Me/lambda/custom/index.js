...
const newSessionHandlers = {
    "LaunchRequest": function() {
        var description = 'What fund would you like to learn about today?';
    ...
    if (isInfoTypeValid(infoType)) {
        ...
        if (searchResults.count > 1) { //multiple results found
            ...
            if (infoType) {
                ...
                console.log("	 was provided as well");
                let product = this.attributes.lastSearch.results[0];
...
function generateSpecificInfoMessage(infoQuery, product) {
    let sentence;

    sentence = product.productName + "'s " + infoQuery.toLowerCase() + " is - " + product[infoQuery.toLowerCase()] + " . Would you like to know anything else about this fund? " + getGenericHelpMessage(data);
    return sentence;
}
